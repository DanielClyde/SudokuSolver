...
export class BoxRegionTests {
  run() {
    ...
    Deno.test('Getting box index 9x9', () => {
      // box 0
      this.checkBox(0, [0, 1, 2], [0, 1, 2]);
      // box 1
      this.checkBox(1, [0, 1, 2], [3, 4, 5]);
      // box 2
      this.checkBox(2, [0, 1, 2], [6, 7, 8]);
      // box 3
      this.checkBox(3, [3, 4, 5], [0, 1, 2]);
      // box 4
      this.checkBox(4, [3, 4, 5], [3, 4, 5]);
      // box 5
      this.checkBox(5, [3, 4, 5], [6, 7, 8]);
      // box 6
      this.checkBox(6, [6, 7, 8], [0, 1, 2]);
      // box 7
      this.checkBox(7, [6, 7, 8], [3, 4, 5]);
      // box 8
      this.checkBox(8, [6, 7, 8], [6, 7, 8]);
    });
  ...
  private checkBox(expectedBox: number, rows: number[], cols: number[]) {
    for (const r of rows) {
      for (const c of cols) {
